...
@Mod(value = GoldenHorizonsCore.MODID, dist = Dist.CLIENT)
// You can use EventBusSubscriber to automatically register all static methods in the class annotated with @SubscribeEvent
@EventBusSubscriber(modid = GoldenHorizonsCore.MODID, value = Dist.CLIENT)
public class CoreClient {
    public CoreClient(ModContainer container) {
